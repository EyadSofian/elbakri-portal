...
export const createCompanySchema = z.object({
  ...
  market: z.enum(['EGYPTIAN', 'INTERNATIONAL', 'GULF', 'FOREIGN', 'MIDDLE_EAST', 'NORTH_AFRICA', 'ARAB_48']).default('INTERNATIONAL'),
...
export const updateCompanySchema = z.object({
  ...
  market: z.enum(['EGYPTIAN', 'INTERNATIONAL', 'GULF', 'FOREIGN', 'MIDDLE_EAST', 'NORTH_AFRICA', 'ARAB_48']).optional(),
