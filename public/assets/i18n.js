(function () {
  ...
  (function () {
    ...
    Object.assign(en.cruise, {
      ...
      rate: "Rate",
      // Fleet-wide programme and transfer library
      fleet: "Cruises",
      library: "Shared programmes and transfers",
      sharedProgrammes: "Shared programmes",
      sharedProgrammesHelp: "Written once and offered on every boat whose sailing is the right length. A boat with its own programme of the same name keeps its own.",
      sharedTransfers: "Shared transfer prices",
      sharedTransfersHelp: "Offered to cruise-only clients on every boat. A programme already includes its transfer, so the two are never charged together.",
      sharedProgrammeRequired: "Every shared programme needs a name and an included transfer route.",
      programmesInheritNote: "This boat also sells every shared programme of the right length. Only add one here when this boat genuinely differs — a programme added here with the same name replaces the shared one.",
      transfersInheritNote: "Shared transfer routes are offered on this boat too. Only add one here when this boat is priced differently.",
      soldOn: "Sold on sailings of",
      soldOnHint: "Offered on every leg of this length, on every boat.",
      anyLength: "Any length",
      // A programme is one price per adult — no sharing basis
      adultPrice: "Adult",
      adultsOnly: "Adult price",
      adultPriceRequired: "Every programme price period needs an adult per-person price for both audiences.",
      allYear: "All year",
      // Choosing a sailing leg
      pickSailing: "Choose a sailing…",
      pickSailingFirst: "Choose a sailing first",
      fareScheduleRequired: "Every fare period needs a From / Back sailing. Check the fares whose sailing reads “Choose a sailing”.",
      whatTheyBuy: "What are they buying?",
      whatTheyBuyHelp: "A programme includes its transfer. Cruise only is the cabin, with an optional transfer priced separately.",
      programmeModeHelp: "Every programme below is sold on this sailing and includes its transfer.",
      guestsAndPrice: "Guests and price",
      guestsAndPriceHelp: "Every amount shown is for one traveller.",
      // Transfers: for how many, and does the car come back
      oneWay: "One way",
      roundTrip: "Round trip",
      oneWayPrice: "One way",
      roundTripPrice: "Round trip",
      roundTripAuto: "2 × one way",
      roundTripHint: "Leave blank and the return is quoted at twice the one-way price.",
      transferDirection: "Direction",
      transferPax: "People being collected",
      transferPaxHint: "Defaults to the whole party — lower it when only some of them need the car.",
      transferBasis: "Priced",
      transferPerPerson: "Per person",
      transferPerVehicle: "Per vehicle — whole party",
    });
    Object.assign(ar.cruise, {
      ...
      rate: "السعر",
      // مكتبة البرامج والترانسفير المشتركة بين كل البواخر
      fleet: "البواخر",
      library: "البرامج والترانسفير المشتركة",
      sharedProgrammes: "البرامج المشتركة",
      sharedProgrammesHelp: "يُكتب البرنامج مرة واحدة ويظهر على كل باخرة يطابق طول رحلتها. والباخرة التي لها برنامج بنفس الاسم تحتفظ ببرنامجها.",
      sharedTransfers: "أسعار الترانسفير المشتركة",
      sharedTransfersHelp: "تُعرض على عملاء «الرحلة فقط» في كل البواخر. البرنامج يشمل ترانسفيره أصلًا، فلا يُحتسب الاثنان معًا أبدًا.",
      sharedProgrammeRequired: "كل برنامج مشترك يحتاج اسمًا ومسار ترانسفير مشمولًا.",
      programmesInheritNote: "هذه الباخرة تبيع أيضًا كل برنامج مشترك بنفس عدد الليالي. لا تضف برنامجًا هنا إلا إذا كانت هذه الباخرة مختلفة فعلًا — والبرنامج المضاف هنا بنفس الاسم يحل محل المشترك.",
      transfersInheritNote: "مسارات الترانسفير المشتركة معروضة على هذه الباخرة أيضًا. لا تضف مسارًا هنا إلا إذا كان سعر هذه الباخرة مختلفًا.",
      soldOn: "يُباع على رحلات مدتها",
      soldOnHint: "يظهر على كل رحلة بهذا الطول، في كل الباخرات.",
      anyLength: "أي مدة",
      // البرنامج سعر واحد للفرد البالغ — بدون سنجل أو دبل أو تربل
      adultPrice: "بالغ",
      adultsOnly: "سعر البالغ",
      adultPriceRequired: "كل فترة سعر في البرنامج تحتاج سعر فرد بالغ للمصريين وللأجانب.",
      allYear: "طوال العام",
      // اختيار موعد التحرك والعودة
      pickSailing: "اختر موعد التحرك…",
      pickSailingFirst: "اختر موعد التحرك أولًا",
      fareScheduleRequired: "كل فترة سعر تحتاج موعد تحرك وعودة. راجع الأسعار التي يظهر بها «اختر موعد التحرك».",
      whatTheyBuy: "ما الذي سيحجزونه؟",
      whatTheyBuyHelp: "البرنامج يشمل الترانسفير. و«الرحلة فقط» هي الكابينة، مع ترانسفير اختياري بسعر منفصل.",
      programmeModeHelp: "كل البرامج التالية تُباع على هذا الموعد وتشمل الترانسفير.",
      guestsAndPrice: "الأفراد والسعر",
      guestsAndPriceHelp: "كل المبالغ المعروضة لفرد واحد.",
      // الترانسفير: لكم فردًا، وهل تعود السيارة
      oneWay: "ذهاب فقط",
      roundTrip: "ذهاب وعودة",
      oneWayPrice: "ذهاب فقط",
      roundTripPrice: "ذهاب وعودة",
      roundTripAuto: "٢ × سعر الذهاب",
      roundTripHint: "اتركه فارغًا ويُحسب سعر العودة بضعف سعر الذهاب.",
      transferDirection: "الاتجاه",
      transferPax: "عدد الأفراد المنقولين",
      transferPaxHint: "يبدأ بعدد المجموعة كاملة — قلّله إذا كان بعضهم فقط يحتاج السيارة.",
      transferBasis: "طريقة التسعير",
      transferPerPerson: "للفرد",
      transferPerVehicle: "للسيارة — المجموعة كاملة",
    });
