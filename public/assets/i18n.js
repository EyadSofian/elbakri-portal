(function () {
  ...
  const en = {
    ...
    form: {
      ...
      validTo: "Valid To", checkIn: "Check-in", checkOut: "Check-out", adults: "Adults", children: "Children",
      nights: "Nights", rooms: "Rooms", availableRooms: "Available rooms", maxGuestsPerRoom: "Guests per room",
      commissionPercent: "Hotel commission %", chooseDates: "Choose hotel dates to calculate the booking amount",
