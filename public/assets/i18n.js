(function () {
  const ar = {
    ...
    login: {
      ...
      unavailable: "الخدمة غير متاحة حاليًا. حاول مرة أخرى بعد قليل",
      tooMany: "محاولات دخول كثيرة. انتظر بضع دقائق ثم حاول مجددًا",
      notConfiguredTitle: "الخادم غير مهيأ",
      notConfigured: "لم يتم ضبط إعدادات الخادم بعد، لذلك لا يمكن تسجيل الدخول. اضبط متغيرات البيئة الناقصة وأعد النشر، أو فعّل DEMO_MODE=1 لتشغيل وضع المعاينة بدون قاعدة بيانات.",
      previewTitle: "وضع المعاينة",
      previewBody: "البيانات كلها تجريبية ولا يتم حفظ أي تعديل. اختر حسابًا لتعبئة بيانات الدخول:",
  ...
  const en = {
    ...
    login: {
      ...
      tooMany: "Too many login attempts. Please wait a few minutes and try again.",
      notConfiguredTitle: "Server not configured",
      notConfigured: "This deployment has no configuration yet, so sign-in cannot work. Set the missing environment variables and redeploy, or set DEMO_MODE=1 to run preview mode without a database.",
      previewTitle: "Preview mode",
      previewBody: "All data is sample data and nothing you change is saved. Pick an account to fill the form:",
