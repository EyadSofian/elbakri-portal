(function () {
  ...
  (function () {
    ...
    Object.assign(en.activity, {
      ...
      transferFixedPrice: "Fixed add-on",
    ...
    Object.assign(ar.activity, {
      ...
      transferFixedPrice: "إضافة بسعر ثابت",
    ...
    Object.assign(en.hotel, {
      ...
      allowQuoteRequest: "Allow quote requests",
    ...
    Object.assign(ar.hotel, {
      ...
      allowQuoteRequest: "السماح بطلب عرض سعر",
    ...
    Object.assign(en.cruise, {
      ...
      gallery: "Photos",
      cruiseOnlyPricing: "Cruise-only prices",
      programmes: "Programmes",
      programmesHelp: "A programme belongs to one sailing and includes its transfer. Add Egyptian/EGP and Foreign/USD per-person prices.",
      programme: "Programme",
      addProgramme: "Add programme",
      transferOnly: "Optional transfer",
      transferOnlyHelp: "A separately priced From → To transfer, offered only when no programme is selected.",
      addTransferRate: "Add transfer price",
      addFarePeriod: "Add price period",
      fareName: "Fare plan",
      sailing: "From / Back",
      perPerson: "per person",
      perChild: "per child",
      perPersonRates: "Per-person prices",
      perPersonHelp: "Single, Double and Triple are sharing bases; every displayed amount is per person.",
      pricePeriod: "Price period",
      bookingType: "Choose what to book",
      bookingTypeHelp: "Choose cruise only, cruise with a programme, or cruise with a separately priced transfer.",
      cruiseOnly: "Cruise only",
      cruiseOnlyHelp: "A programme includes transfer; cruise-only can add a separately priced transfer.",
      cruiseOnlyProductHelp: "Accommodation without a programme or transfer.",
      cruiseWithProgramme: "Cruise + programme",
      cruiseWithProgrammeHelp: "Choose a 3- or 4-night programme; its transfer is included.",
      cruiseWithTransfer: "Cruise + transfer",
      cruiseWithTransferHelp: "Cruise fare plus a separately priced vehicle.",
      programmeOptions: "Available programmes",
      allProgrammeDurationsHelp: "All 3- and 4-night programmes are shown. Choosing one selects its matching sailing automatically.",
      programmeUnavailableOnDate: "Not available for the selected sailing date",
      chooseProgrammeRequired: "Choose an available programme with a valid price period for this sailing date.",
      chooseTransferRequired: "Choose an available transfer vehicle before requesting the quote.",
      transferModeNote: "Choose the sailing above, then choose the vehicle below with its route and price.",
      choice: "Choice",
      optionalTransfer: "Optional transfer",
      transferRoute: "Transfer route",
      noTransfer: "No transfer",
      noTransferRate: "No optional transfer price is configured for this sailing.",
      pickup: "Pickup",
      cruise: "Nile cruise",
      childPriceMissing: "No child price is configured for this period. Send a price request.",
      programmeTransferIncluded: "Transfer is included automatically when this programme is selected.",
      programmeMarkets: "Egyptians in EGP · Foreigners in USD",
      programmeMarketsRequired: "Every programme needs Egyptian/EGP and Foreign/USD prices.",
      programmeScheduleRequired: "Every programme needs a name, From / Back schedule and included transfer route.",
      transferRateInvalid: "Check transfer From, To, market, schedule and price.",
      sailingDate: "Sailing date",
      rate: "Rate",
      shipsTab: "Cruises",
      sharedCatalogue: "Shared programmes & transfers",
      sharedCatalogueHelp: "Define them once. They are copied automatically to every matching cruise route and 3/4-night sailing.",
      sharedProgrammeHelp: "Choose route and nights once; the programme appears on every matching cruise.",
      sharedTransferHelp: "Add a separate row for each one-way or round-trip vehicle. The price is for the whole vehicle, not per person.",
      transferPricingTitle: "Vehicle pricing",
      transferProduct: "Transfer vehicle",
      transferProductHelp: "One row is one vehicle price for one-way or round-trip.",
      vehicleCapacity: "Maximum passengers",
      capacityHelp: "More passengers automatically require another vehicle.",
      pricePerVehicle: "Price per vehicle",
      available: "Available to book",
      adultPerPerson: "Adult · per person",
      addSupplement: "Add supplement",
      programmePerPersonHelp: "The programme has one adult price and one child price per traveller — no Single, Double or Triple choice.",
      programmeAdultPriceRequired: "Enter the adult per-person price for every programme market.",
      oneWayPerPerson: "One-way · per person",
      roundTripPerPerson: "Round-trip · per person",
      oneWay: "One-way",
      roundTrip: "Round-trip",
      transferPassengers: "Transfer passengers",
      transferVehicleHelp: "Choose one vehicle product. Its price covers the whole vehicle up to its stated capacity.",
      transferVehicleChoice: "Transfer vehicle",
      upToPassengers: "up to {count} passengers",
      vehicle: "vehicle",
      vehicles: "vehicles",
      noProgrammes: "No programmes yet",
      noTransferRates: "No transfer prices yet",
    });
    Object.assign(ar.cruise, {
      ...
      gallery: "الصور",
      cruiseOnlyPricing: "أسعار الكروز فقط",
      programmes: "البرامج",
      programmesHelp: "كل برنامج مرتبط بموعد تحرك وعودة واحد ويشمل الترانسفير. أضف سعر المصريين بالجنيه والأجانب بالدولار للفرد.",
      programme: "البرنامج",
      addProgramme: "أضف برنامجًا",
      transferOnly: "ترانسفير اختياري",
      transferOnlyHelp: "ترانسفير منفصل بسعر ومسار من ← إلى، ويظهر فقط عند عدم اختيار برنامج.",
      addTransferRate: "أضف سعر ترانسفير",
      addFarePeriod: "أضف فترة سعر",
      fareName: "اسم خطة السعر",
      sailing: "التحرك / العودة",
      perPerson: "للفرد",
      perChild: "للطفل",
      perPersonRates: "الأسعار للفرد",
      perPersonHelp: "السنجل والدبل والتربل أنواع إقامة، وكل مبلغ ظاهر محسوب للفرد.",
      pricePeriod: "فترة السعر",
      bookingType: "اختر نوع الحجز",
      bookingTypeHelp: "اختر كروز فقط، أو كروز مع برنامج، أو كروز مع ترانسفير منفصل بسعره.",
      cruiseOnly: "كروز فقط",
      cruiseOnlyHelp: "البرنامج يشمل الترانسفير؛ أما الكروز فقط فيمكن إضافة ترانسفير منفصل بسعره.",
      cruiseOnlyProductHelp: "إقامة الكروز فقط من غير برنامج ومن غير ترانسفير.",
      cruiseWithProgramme: "كروز + برنامج",
      cruiseWithProgrammeHelp: "اختر برنامج ٣ أو ٤ ليالي؛ الترانسفير مشمول داخله.",
      cruiseWithTransfer: "كروز + ترانسفير",
      cruiseWithTransferHelp: "سعر الكروز مع عربية ترانسفير منفصلة بسعرها.",
      programmeOptions: "البرامج المتاحة",
      allProgrammeDurationsHelp: "كل برامج ٣ و٤ ليالي ظاهرة. اختيار البرنامج يحدد موعده المناسب تلقائيًا.",
      programmeUnavailableOnDate: "غير متاح لتاريخ التحرك المختار",
      chooseProgrammeRequired: "اختر برنامجًا متاحًا وله فترة سعر صالحة لتاريخ التحرك.",
      chooseTransferRequired: "اختر عربية ترانسفير متاحة قبل إرسال طلب السعر.",
      transferModeNote: "اختر موعد التحرك بالأعلى، ثم اختر العربية بالمسار والسعر من الأسفل.",
      choice: "الاختيار",
      optionalTransfer: "ترانسفير اختياري",
      transferRoute: "مسار الترانسفير",
      noTransfer: "بدون ترانسفير",
      noTransferRate: "لا يوجد سعر ترانسفير اختياري لهذا الموعد.",
      pickup: "الاستلام",
      cruise: "رحلة النيل",
      childPriceMissing: "لا يوجد سعر طفل لهذه الفترة. أرسل طلب تسعير.",
      programmeTransferIncluded: "الترانسفير يُحتسب تلقائيًا ضمن السعر عند اختيار هذا البرنامج.",
      programmeMarkets: "المصريون بالجنيه · الأجانب بالدولار",
      programmeMarketsRequired: "كل برنامج يحتاج أسعارًا للمصريين بالجنيه وللأجانب بالدولار.",
      programmeScheduleRequired: "كل برنامج يحتاج اسمًا وموعد تحرك وعودة ومسار ترانسفير مشمول.",
      transferRateInvalid: "راجع من وإلى والسوق والموعد وسعر الترانسفير.",
      sailingDate: "تاريخ التحرك",
      rate: "السعر",
      shipsTab: "رحلات النيل",
      sharedCatalogue: "البرامج والترانسفير المشترك",
      sharedCatalogueHelp: "عرّف البرنامج والترانسفير مرة واحدة، وسيُطبّقان تلقائيًا على كل كروز بنفس المسار وعدد الليالي.",
      sharedProgrammeHelp: "اختر المسار وعدد الليالي مرة واحدة؛ وسيظهر البرنامج في كل كروز مطابق.",
      sharedTransferHelp: "أضف صفًا منفصلًا لكل عربية ذهاب فقط أو ذهاب وعودة. السعر للعربية كاملة وليس للفرد.",
      transferPricingTitle: "تسعير العربية",
      transferProduct: "عربية الترانسفير",
      transferProductHelp: "كل صف هو سعر عربية واحد لذهاب فقط أو ذهاب وعودة.",
      vehicleCapacity: "أقصى عدد ركاب",
      capacityHelp: "عند زيادة الركاب عن السعة تُحسب عربية إضافية تلقائيًا.",
      pricePerVehicle: "سعر العربية",
      available: "متاح للحجز",
      adultPerPerson: "البالغ · للفرد",
      addSupplement: "إضافة ملحق سعر",
      programmePerPersonHelp: "للبرنامج سعر بالغ وسعر طفل لكل مسافر — من غير اختيار سنجل أو دبل أو تربل.",
      programmeAdultPriceRequired: "أدخل سعر البالغ للفرد لكل سوق في البرنامج.",
      oneWayPerPerson: "ذهاب فقط · للفرد",
      roundTripPerPerson: "ذهاب وعودة · للفرد",
      oneWay: "ذهاب فقط",
      roundTrip: "ذهاب وعودة",
      transferPassengers: "عدد أفراد الترانسفير",
      transferVehicleHelp: "اختر نوع عربية واحدًا. السعر للعربية كاملة حتى السعة الموضحة.",
      transferVehicleChoice: "عربية الترانسفير",
      upToPassengers: "حتى {count} ركاب",
      vehicle: "عربية",
      vehicles: "عربيات",
      noProgrammes: "لا توجد برامج بعد",
      noTransferRates: "لا توجد أسعار ترانسفير بعد",
    });
  ...
  (function () {
    ...
    Object.assign(en.activityAdmin, {
      ...
      transferTitle: "Activity transfer",
      transferDecisionHelp: "Choose whether pickup is already covered by the activity price.",
      includedInPrice: "Included in price",
      includedInPriceHelp: "No extra charge or separate transfer form for the agent.",
      notIncludedPaid: "Not included · paid add-on",
      notIncludedPaidHelp: "The agent can add it and the price is added once to the booking.",
      transferDetailsHelp: "Set the fixed transfer price and its default route. The agent may enter the exact hotel or address when booking.",
      transferPrice: "Transfer price",
      pricePerBooking: "Fixed price once per booking",
      transferFrom: "Default pickup from",
      transferTo: "Default return to",
      transferFromPlaceholder: "Hotel / area / address",
      transferToPlaceholder: "Activity point / hotel / area",
      returnTime: "Return time",
      returnTimeHelp: "Prefills the return transfer time",
    ...
    Object.assign(ar.activityAdmin, {
      ...
      transferIncluded: "الانتقالات مشمولة في السعر",
      transferTitle: "ترانسفير الاكتيفتي",
      transferDecisionHelp: "حدد هل الاستلام مشمول بالفعل في سعر الاكتيفتي أم يُضاف بسعر منفصل.",
      includedInPrice: "مشمول في السعر",
      includedInPriceHelp: "لا توجد تكلفة إضافية ولا يظهر فورم ترانسفير منفصل للوكيل.",
      notIncludedPaid: "غير مشمول · إضافة مدفوعة",
      notIncludedPaidHelp: "يقدر الوكيل يضيفه، ويُضاف سعره مرة واحدة على الحجز.",
      transferDetailsHelp: "حدد سعر الترانسفير الثابت والمسار الافتراضي، والوكيل يكتب الفندق أو العنوان بالتحديد وقت الحجز.",
      transferPrice: "سعر الترانسفير",
      pricePerBooking: "سعر ثابت مرة واحدة لكل حجز",
      transferFrom: "الاستلام افتراضيًا من",
      transferTo: "العودة افتراضيًا إلى",
      transferFromPlaceholder: "فندق / منطقة / عنوان",
      transferToPlaceholder: "نقطة الاكتيفتي / فندق / منطقة",
      returnTime: "موعد الرجوع",
      returnTimeHelp: "يُملأ به موعد العودة في حجز الترانسفير",
